...
function downloadApp() {
    ...
    // Show download modal
    showModal('Download Started!', 'Your NearChat app download should begin shortly. Check your downloads folder.');
}
...
function submitFeedback(event) {
    ...
    if (name && email && message) {
        ...
        // Show success modal
        showModal('Thank You!', `Hi ${name}! Your feedback has been sent successfully. We appreciate your input and will get back to you soon.`);
    }
}
